...
class MicGain : Plugin() {
    ...
    override fun start(context: Context) {
        ...
        // Hack #1: Short Array
        patcher.patch(AudioRecord::class.java.getDeclaredMethod("read", ShortArray::class.java, Integer.TYPE, Integer.TYPE), PostHook { callFrame ->
        ...
        // Hack #2: Byte Array
        patcher.patch(AudioRecord::class.java.getDeclaredMethod("read", ByteArray::class.java, Integer.TYPE, Integer.TYPE), PostHook { callFrame ->
            val readSize = callFrame.result as Int
            if (readSize > 0) {
        ...
        // Hack #3: ByteBuffer (WebRTC)
        patcher.patch(AudioRecord::class.java.getDeclaredMethod("read", ByteBuffer::class.java, Integer.TYPE), PostHook { callFrame ->
            val readSize = callFrame.result as Int
            if (readSize > 0) {
